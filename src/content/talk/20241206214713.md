...
<text-center>しかも未使用のCSSを<br>静的解析で検出できる！</text-center>
...
<text-center>※ SliderコンポーネントのPropsに<br>渡すわけではない</text-center>
...
<text-center>自然とJotaiっぽくなる</text-center>
...
<text-center>依存に含めたくない場合は<br>`untrack`関数を使います</text-center>
...
<text-center>更新もシンプルなものなら<br>Promiseに再代入するだけでOK</text-center>
